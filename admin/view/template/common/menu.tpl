<ul id="menu">
  ...
  <li id="faturalar"><a class="parent"><i class="fa fa-file-text-o fa-fw"></i> <span><?php echo $text_faturalar; ?></span></a>
      <ul>
          <li><a href="<?php echo $fatura_service; ?>"><?php echo $text_service; ?></a></li>
          <li><a href="<?php echo $fatura_ticket_hotel; ?>"><?php echo $text_ticket_hotel; ?></a></li>
      </ul>      
  </li>
</ul>
