...
class ControllerInvoiceInvHotel extends Controller {

    public function index() {
        $this->load->language('invoice/ticket');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('invoice/ticket', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );

        $this->load->model('invoice/ticket');
        ...
        $marketing_total = $this->model_invoice_ticket->getTotalMarketing($filter_data);

        $results = $this->model_invoice_ticket->getMarketing($filter_data);
        ...
        $pagination->url = $this->url->link('invoice/ticket', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        $this->response->setOutput($this->load->view('invoice/invhotel.tpl', $data));
    }
