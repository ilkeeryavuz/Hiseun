...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_faturalar'] = $this->language->get('text_faturalar');
		$data['text_service'] = $this->language->get('text_service');
		$data['text_ticket_hotel'] = $this->language->get('text_ticket_hotel');
		$data['text_newsletter'] = $this->language->get('text_newsletter');

		
		$data['newsletter'] = $this->url->link('marketing/newsletter', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['openbay_markets'] = array(
			...
			'etsy' => $this->config->get('etsy_status'),
                ...
                $data['fatura_service'] = $this->url->link('invoice/service', 'token=' . $this->session->data['token'], 'SSL');
                $data['fatura_ticket_hotel'] = $this->url->link('invoice/hotel', 'token=' . $this->session->data['token'], 'SSL');
