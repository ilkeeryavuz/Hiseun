...
$_['text_donate'] = 'If you like this module you can buy me a cup of coffee.<br><a href="%1$s" target="_blank">PayPal</a>, <a href="%2$s" target="_blank">Yandex.Money</a>';
...
$_['error_pre_action_place_not_found'] = 'Couldn\'t find place for register pre action!';
...
$_['help_pre_action_file_manual_insert_unknown_place'] = 'You can manually add the the code below into <code>%s</code> file just before seo url pre action registration';
