...
////////////////////GUEST D�ZENLEMES� BA�LAR////////////////////////////////////////////////////////
  ...
  $data['zone'] = '';
	...
	/////////////GUEST D�ZENLEMES� B�TER//////////////////////////////////////////////////////////////		
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/sozlesme.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/checkout/sozlesme.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/checkout/sozlesme.tpl', $data));
			}
