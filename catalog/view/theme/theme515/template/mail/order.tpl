...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
    ...
    <!-- ÖN BİLGİLENDİRME FORMU START --> 
    <div>
        
        <div align="center"><strong>Ön Bilgilendirme Formu</strong></div>
        <div>
            <div align="left">
        ...
        <div>
            ...
            <table style="width:98%;border:0px solid #ddd;padding:10px;" valign="top" border="0">
                ...
                <div class="left" style="padding-bottom:10px;">
                    <span style="font-weight:400">Firma Adı :</span> Hiseun İklimlendirme Sistemleri Turizm İnşaat Medikal ve Kozmetik İthalat İhracat Limited Şirketi<br />
                    <span style="font-weight:400">Yetkili / Sahibi :</span> Seçkin ÜNLÜ<br />
                    <span style="font-weight:400">Adresi :</span> Aşık Veysel Mahallesi Vedat Altun Sokak Orkide Evleri B-24 Blok No:13 G / 03 Esenkent / Esenyurt / İstanbul Beylikdüzü V.D. : 4630591801 Ticaret Sicil No : 85075-5 Mersis No : 046305918010001<br />
                    <span style="font-weight:400">E-mail :</span> info@hiseun.com<br />
                    <span style="font-weight:400">Telefon :</span> +90-212-672-24-55<br />
                    <?php if (!empty($config_fax)) { ?><span style="font-weight:400"><?php echo $entry_fax; ?></span> <?php echo $config_fax; ?><br /><?php } ?>
                    <div class="left" style="padding-top:5px;"><span style="font-weight:400">Müşteri Hizmetleri Telefon :</span> +90-212-672-24-55<br /></div>
                </div>
                </td>
                </tr>
            </table>
            ...
            <div class="clr5">
                ...
                <div class="left" style="padding-left:20px;padding-bottom:5px;">
                    ...
                    <?php if (!empty($payment_company)) { echo $payment_company; ?><br /><?php } ?>
                    <?php echo $telephone; ?>
                </div>
                ...
                <div class="left" style="padding-left:20px;padding-bottom:5px;">
                    ...
                    <?php if (!empty($shipping_company)) { echo $shipping_company; ?><br /><?php } ?>
                    <?php echo $telephone; ?>
                </div>			
            </div>		
    ...
    <!-- ÖN BİLGİLENDİRME FORMU END -->  
    
    
    <!-- MESAFELİ SATIŞ SÖZLEŞMESİ START -->
    
    <div>
        <div align="center"><strong>Mesafeli Satış Sözleşmesi</strong></div>
        <div>
            <div align="left">
                27 Kasım 2014 Perşembe tarih ve 29188 sayılı Resmî Gazetede yayınlanan<br />
                Mesafeli Sözleşmeler Yönetmeliğine göre düzenlenmiştir.
            ...
            <div class="clr5">
                <table border="0">
                    <tr height="25">
                        ...
                        <td width="75%"><strong>:</strong>Hiseun İklimlendirme Sistemleri Turizm İnşaat Medikal ve Kozmetik İthalat İhracat Limited Şirketi</td>
                    </tr>
                    <tr height="25">
                        ...
                        <?php
                            ...
                            $names = explode(" ", $payment_address);
                            
                        ?>
                        
                        
                        <td width="75%"><strong>:</strong> <?php echo $names[0]; ?> <?php echo $names[1]; ?></td>
                    </tr>
                    <tr height="25">
