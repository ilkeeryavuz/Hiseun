...
<head>
    ...
    <link href="catalog/view/javascript/camera/css/camera.css" rel="stylesheet" media="screen">
    <link href="catalog/view/theme/theme515/js/fancybox/jquery.fancybox.css" rel="stylesheet" media="screen"/>
    <link href="catalog/view/theme/theme515/stylesheet/livesearch.css" rel="stylesheet" media="screen">
    <link href="catalog/view/theme/theme515/stylesheet/owl-carousel.css" rel="stylesheet" media="screen">
    <link href="catalog/view/theme/theme515/stylesheet/photoswipe.min.css" rel="stylesheet" media="screen">
    <link href="catalog/view/theme/theme515/js/jquery.bxslider/jquery.bxslider.css" rel="stylesheet" media="screen">
    <link href="catalog/view/theme/theme515/stylesheet/material-design.css" rel="stylesheet" media="screen">
    <link href="catalog/view/theme/theme515/stylesheet/stylesheet.min.css" rel="stylesheet" media="screen">
    ...
    <script src="catalog/view/theme/theme515/js/superfish.min.js" type="text/javascript" async="async"></script>
    <script src="catalog/view/theme/theme515/js/jquery.ui.totop.js" async="async"></script>
    <script src="catalog/view/theme/theme515/js/owl.carousel.min.js" async="async"></script>
    <!--Green Sock-->
    ...
    <script src="catalog/view/theme/theme515/js/greensock/jquery.scrollmagic.min.js" type="text/javascript" async="async"></script>
